//////////////////////////////////////////////////////////////////
//
// hil_task_read_continuously_example.c - C file
//
...
#include "hil_task_read_continuously_example.h"
...
int main(int argc, char* argv[])
{
    ...
    if (result == 0)
    {
        ...
        #define SAMPLES                 -1  /* read continuously */
        ...
        printf("two times a second, continuously.\n");
